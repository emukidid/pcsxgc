...
{ //	button	buttonStyle x		width	Up	Dwn	Lft	Rt	clickFunc				
	...
	{	NULL,	BTN_A_SEL,	170.0,	130.0,	BTN_CONF_INPUT,		BTN_PAD2_STANDARD,	BTN_PAD1_MOUSE,		BTN_PAD1_ANALOG,	Func_Pad1TypeStandard,	TAB_INPUT, LBL_INPUT_CONT1_TYPE, BTN_PAD1_STANDARD }, // PAD1 Type: Standard
	{	NULL,	BTN_A_SEL,	305.0,	110.0,	BTN_CONF_INPUT,		BTN_PAD2_ANALOG,	BTN_PAD1_STANDARD,	BTN_PAD1_GUN,		Func_Pad1TypeAnalog,	TAB_INPUT, LBL_INPUT_CONT1_TYPE, BTN_PAD1_ANALOG }, // PAD1 Type: Analog
	{	NULL,	BTN_A_SEL,	420.0,	 75.0,	BTN_CONF_BTN_MAP,	BTN_PAD2_GUN,		BTN_PAD1_ANALOG,	BTN_PAD1_MOUSE,		Func_Pad1TypeLightgun,	TAB_INPUT, LBL_INPUT_CONT1_TYPE, BTN_PAD1_GUN }, // PAD1 Type: Gun
	{	NULL,	BTN_A_SEL,	500.0,	100.0,	BTN_CONF_BTN_MAP,	BTN_PAD2_MOUSE,		BTN_PAD1_GUN,		BTN_PAD1_STANDARD,	Func_Pad1TypeMouse,		TAB_INPUT, LBL_INPUT_CONT1_TYPE, BTN_PAD1_MOUSE }, // PAD1 Type: Mouse
	{	NULL,	BTN_A_SEL,	170.0,	130.0,	BTN_PAD1_STANDARD,	BTN_PAD3_STANDARD,	BTN_PAD2_MOUSE,		BTN_PAD2_ANALOG,	Func_Pad2TypeStandard,	TAB_INPUT, LBL_INPUT_CONT2_TYPE, BTN_PAD2_STANDARD }, // PAD2 Type: Standard
	{	NULL,	BTN_A_SEL,	305.0,	110.0,	BTN_PAD1_ANALOG,	BTN_PAD3_ANALOG,	BTN_PAD2_STANDARD,	BTN_PAD2_GUN,		Func_Pad2TypeAnalog,	TAB_INPUT, LBL_INPUT_CONT2_TYPE, BTN_PAD2_ANALOG }, // PAD2 Type: Analog
	{	NULL,	BTN_A_SEL,	420.0,	 75.0,	BTN_PAD1_GUN,		BTN_PAD3_GUN,		BTN_PAD2_ANALOG,	BTN_PAD2_MOUSE,		Func_Pad2TypeLightgun,	TAB_INPUT, LBL_INPUT_CONT2_TYPE, BTN_PAD2_GUN }, // PAD2 Type: Gun
	{	NULL,	BTN_A_SEL,	500.0,	100.0,	BTN_PAD1_MOUSE,		BTN_PAD3_MOUSE,		BTN_PAD2_GUN,		BTN_PAD2_STANDARD,	Func_Pad2TypeMouse,		TAB_INPUT, LBL_INPUT_CONT2_TYPE, BTN_PAD2_MOUSE }, // PAD2 Type: Mouse
	{	NULL,	BTN_A_SEL,	170.0,	130.0,	BTN_PAD2_STANDARD,	BTN_PAD4_STANDARD,	BTN_PAD3_MOUSE,		BTN_PAD3_ANALOG,	Func_Pad3TypeStandard,	TAB_INPUT, LBL_INPUT_CONT3_TYPE, BTN_PAD3_STANDARD }, // PAD3 Type: Standard
	{	NULL,	BTN_A_SEL,	305.0,	110.0,	BTN_PAD2_ANALOG,	BTN_PAD4_ANALOG,	BTN_PAD3_STANDARD,	BTN_PAD3_GUN,		Func_Pad3TypeAnalog,	TAB_INPUT, LBL_INPUT_CONT3_TYPE, BTN_PAD3_ANALOG }, // PAD3 Type: Analog
	{	NULL,	BTN_A_SEL,	420.0,	 75.0,	BTN_PAD2_GUN,		BTN_PAD4_GUN,		BTN_PAD3_ANALOG,	BTN_PAD3_MOUSE,		Func_Pad3TypeLightgun,	TAB_INPUT, LBL_INPUT_CONT3_TYPE, BTN_PAD3_GUN }, // PAD3 Type: Gun
	{	NULL,	BTN_A_SEL,	500.0,	100.0,	BTN_PAD2_MOUSE,		BTN_PAD4_MOUSE,		BTN_PAD3_GUN,		BTN_PAD3_STANDARD,	Func_Pad3TypeMouse,		TAB_INPUT, LBL_INPUT_CONT3_TYPE, BTN_PAD3_MOUSE }, // PAD3 Type: Mouse
	{	NULL,	BTN_A_SEL,	170.0,	130.0,	BTN_PAD3_STANDARD,	BTN_RUMBLE_YES,		BTN_PAD4_MOUSE,		BTN_PAD4_ANALOG,	Func_Pad4TypeStandard,	TAB_INPUT, LBL_INPUT_CONT4_TYPE, BTN_PAD4_STANDARD }, // PAD4 Type: Standard
	{	NULL,	BTN_A_SEL,	305.0,	110.0,	BTN_PAD3_ANALOG,	BTN_RUMBLE_YES,		BTN_PAD4_STANDARD,	BTN_PAD4_GUN,		Func_Pad4TypeAnalog,	TAB_INPUT, LBL_INPUT_CONT4_TYPE, BTN_PAD4_ANALOG }, // PAD4 Type: Analog
	{	NULL,	BTN_A_SEL,	420.0,	 75.0,	BTN_PAD3_GUN,		BTN_RUMBLE_NO,		BTN_PAD4_ANALOG,	BTN_PAD4_MOUSE,		Func_Pad4TypeLightgun,	TAB_INPUT, LBL_INPUT_CONT4_TYPE, BTN_PAD4_GUN }, // PAD4 Type: Gun
	{	NULL,	BTN_A_SEL,	500.0,	100.0,	BTN_PAD3_MOUSE,		BTN_RUMBLE_NO,		BTN_PAD4_GUN,		BTN_PAD4_STANDARD,	Func_Pad4TypeMouse,		TAB_INPUT, LBL_INPUT_CONT4_TYPE, BTN_PAD4_MOUSE }, // PAD4 Type: Mouse
...
{ //	textBox	x		y		tabGrpId		lblGrpId
	...
	{	NULL,	115.0,	TAB_INPUT,		LBL_INPUT_CONT2_TYPE }, // PAD2 Type: Analog/Digital/Gun/Mouse
	{	NULL,	115.0,	TAB_INPUT,		LBL_INPUT_CONT3_TYPE }, // PAD3 Type: Analog/Digital/Gun/Mouse
	{	NULL,	115.0,	TAB_INPUT,		LBL_INPUT_CONT4_TYPE }, // PAD4 Type: Analog/Digital/Gun/Mouse
