...
short          sSprite_vy2;                            // 
u32  ulOLDCOL=0;                             // active color
u32  ulClutID;                               // clut

u32 dwCfgFixes;                              // game fixes
u32 dwActFixes=0;
u32 dwEmuFixes=0;
BOOL          bUseFixes;

s32          drawX,drawY,drawW,drawH;                 // offscreen drawing checkers
...
void SetRenderState(u32 DrawAttributes)
{
...
void SetRenderColor(u32 DrawAttributes)
{
...
void SetRenderMode(u32 DrawAttributes,BOOL bSCol)
{
...
void SetOpaqueColor(u32 DrawAttributes)
{
...
void UploadScreenEx(s32 Position)
{
   ...
   for(x=xa;x<=xb;x+=XStep)                            // loop x
    {
     ...
     SetRenderState((u32)0x01000000);
     SetRenderMode((u32)0x01000000, FALSE);  // upload texture data
     offsetScreenUpload(Position);
	...
	gxEnable(GX_SCISSOR_TEST);
     ...
     if(GETLE32(&gpuData[0])!=0x02000000 &&
         ...
         ly2<pd->DisplayEnd.y))
      {
       ...
       bDrawSmoothShaded = FALSE;
       SetRenderState((u32)0x01000000);
       SetRenderMode((u32)0x01000000, FALSE);
